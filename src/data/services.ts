...
export const services: Service[] = [
  {
    ...
    benefits: [
      ...
      "Maintenance et monitoring inclus (15-25 ans)",
  ...
  },
  {
    ...
    description:
      "Un investisseur finance votre installation solaire. Vous bénéficiez de l'électricité ou d'un loyer de toiture. Contrat de 15 à 25 ans, maintenance incluse.",
    longDescription:
      "Le tiers-investissement est un modèle de financement dans lequel un investisseur externe prend en charge 100% du coût de l'installation photovoltaïque sur votre bâtiment. Trois formules existent : la location de toiture (vous percevez un loyer annuel), le PPA — Power Purchase Agreement (vous achetez l'électricité produite à un prix inférieur au marché), ou le crédit-bail (avec option d'achat en fin de contrat). La durée typique est de 15 à 25 ans. La maintenance, le monitoring et l'assurance sont inclus pendant toute la durée. À l'issue du contrat, vous pouvez récupérer l'installation ou la faire démonter gratuitement.",
    icon: "TrendingUp",
    features: [
      "Aucun investissement initial (0 € à votre charge)",
      "Aucun emprunt nécessaire",
      "3 modèles : location de toiture, PPA, crédit-bail",
      "Contrat de 15 à 25 ans (durée selon le projet)",
    ...
    benefits: [
      ...
      "Électricité verte à prix fixe (PPA)",
      "Conformité réglementaire (Loi APER, Décret Tertiaire)",
      "Accompagnement administratif complet",
      "Garantie de performance contractuelle (25 ans panneaux)",
    ],
