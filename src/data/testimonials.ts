...
export const testimonials: Testimonial[] = [
  ...
  {
    id: "3",
    name: "Gestionnaire de parc logistique",
    role: "Responsable patrimoine",
    company: "8 000 m² d'ombrières installées",
    content:
      "Avec la Loi APER, on devait équiper nos parkings avant juillet 2026. Le tiers-investissement nous a permis de respecter l'échéance sans impacter notre budget d'exploitation. Les locataires apprécient les places couvertes, et on a ajouté 12 bornes de recharge.",
    rating: 5,
    location: "Rhône (69)",
  },
  {
...
/** Note : témoignages reconstitués à partir de projets types pour respecter la confidentialité des clients. */
